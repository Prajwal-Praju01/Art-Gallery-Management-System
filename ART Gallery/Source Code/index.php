...
<html>
   ...
   <body>
      ...
      <header id="header" class="alt" >
         <div class="logo"><a href="index.php">Online <span> Art Gallery</span></a></div>
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Design & Develop By TEAM | Visit : www.artwork.com</div>
             TEAM Artwork Online Studio.All rights reserved.
         </div>
      </footer>
      <!-- Scripts -->
