...
">
<head>
<title>Admin - <?php echo $_SESSION["admin"]; ?> - Online Art Gallery</title>
<meta charset="utf-8">
...
<nav class="#header">
  ...
  <!-- Header -->
			<header id="header" class="alt">
				<div class="logo"><a href="index.php"><span>Online Art_gallery</span></a></div>
				<a href="#menu"><p class="custom-para">Login</p></a>
			</header>
